...
def _create_gt_graph(geoJson, im_test_file, network_type='all_private',
    ...
    # add pixel coords
    G_gt_almost, _, gt_graph_coords = apls_utils._set_pix_coords(G2gt_init2.copy(),
                                                     im_test_file)
...
#            #########################
        ...
        for i, f in enumerate(name_list):
            ...
            if verbose:
                ...
                try:
                    ...
                    # G.edge[edge_tmp[0]][edge_tmp[1]])
                    print("rprop andom edge props for edge:", edge_tmp,
    ...
    if test_method == 'gt_json_prop_json':
        ...
        for f in name_list:
            ...
            G_p_init, G_p_raw = \
                _create_gt_graph(prop_file, im_file, network_type='all_private',
                                 # linestring_delta=args.linestring_delta,
                                 # is_curved_eps=args.is_curved_eps,
                                 valid_road_types=valid_road_types,
                                 #weight=weight,
...
#              subgraph_radius, interval)
#        print("TOPO Metric =", topo_vals, "for", n_measurement_nodes,
#              "nodes, subgraph_radius =", subgraph_radius)
#
#        # TODO : compute SP Metric
#        print("\nComputing sp Metric...")
